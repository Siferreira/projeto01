...
$querySQL = mysqli_query($mysqli, "SELECT * FROM tbNivelAcesso ORDER BY tipoAcesso") or die(mysqli_error($mysqli));

$idLogin = "1";//para nao dar erro na tabela
?>
<!doctype html>
<html>
<head>
    <title>Cadastro ACL - Master</title>
    <meta charset="utf-8" />
                ...
                <div>
                    ...
                    <h2>Consulta de ACL</h2>
                        ...
                        while($aux = mysqli_fetch_assoc($querySQL)){
                            ...
                            <td><a href ='altera-acl-master.php?idNivelAcesso='".$aux["idNivelAcesso"].">Alterar</a></td>
                        </tr>"; 
                        }
                        ?>
                    </table>
