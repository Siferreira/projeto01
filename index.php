    ...
    <div id="page">
        ...
        <main>
            ...
            <div class="row container">
                <div class="title-content"><h2>Título da Área</h2></div>
                <div class="col-4">
                    <img src="public/img/produto.jpg" alt="" title="">
                    <p>Lorem ipsum in sed donec euismod.</p>
                </div>
                <div class="col-4">
                    <img src="public/img/produto.jpg" alt="" title="">
            ...
            <div class="row">
                <div class="title-content"><h2>Título da Área</h2></div>
                <div class="col-3"><iframe src="https://www.youtube.com/embed/e36n-H6uoMk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                <div class="col-3">
                    <p>Lorem ipsum tincidunt nibh tristique nulla curae vehicula, sollicitudin porttitor fusce donec sociosqu eu, a pharetra torquent malesuada nostra mauris.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Pellentesque dignissim enim sit amet venenatis urna cursus eget. Et netus et malesuada fames ac. Pretium aenean pharetra magna ac placerat. Vel turpis nunc eget lorem dolor sed viverra ipsum. Nunc mi ipsum faucibus vitae. Non quam lacus suspendisse faucibus. Proin nibh nisl condimentum id venenatis a condimentum. Eget felis eget nunc lobortis mattis aliquam. Tortor condimentum lacinia quis vel eros. Mattis ullamcorper velit sed ullamcorper. Mattis nunc sed blandit libero. Pharetra et ultrices neque ornare. Diam sit amet nisl suscipit adipiscing. Morbi enim nunc faucibus a pellentesque sit.</p>
                </div>
                <div class="col-3">
                    <img src="public/img/cidades.jpg" alt="" title="">
                </div>
            </div>
            <!--linha 4-->
            <div class="row container">
                <div class="title-content"><h2>Título da Área</h2></div>
                <div class="col-2">
                        <img src="public/img/col-2.jpg" alt="" title="">
                        <p>Lorem ipsum tincidunt nibh tristique nulla curae vehicula, sollicitudin porttitor fusce donec sociosqu eu, a pharetra torquent malesuada nostra mauris.</p>
                </div>
                <div class="col-2">
                        <img src="public/img/col-2.jpg" alt="" title="">
                        <p>Lorem ipsum tincidunt nibh tristique nulla curae vehicula, sollicitudin porttitor fusce donec sociosqu eu, a pharetra torquent malesuada nostra mauris.</p>
            ...
            <div class="row brand">
                <div class="title-content"><h2>Título da Área</h2></div>
                <div class="col-3">
                    <img src="public/img/col-6.jpg" alt="" title="">
                    <img src="public/img/col-6.jpg" alt="" title="">
                </div>
                <div class="col-3">
                    <img src="public/img/col-6.jpg" alt="" title="">
